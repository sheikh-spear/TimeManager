    ...
    <div class="row">
      <div class="col-md-5">
        <div class="card mb-4">
          ...
          />
          <div class="card-body">
            <h5 class="card-title">{{ this.managerName }}</h5>
            <span class="card-text">Manager of the team</span>
          </div>
        </div>
      </div>
      <div class="col-md-7">
          ...
          <div v-for="user in users" :key="user.id" class="col">
            <div class="card mb-4" style="width: 13rem">
              ...
              <div class="card-body">
                ...
                <p v-else-if="user.is_manager == true" class="card-text">
                  Manager
                </p>
                <div v-else>
